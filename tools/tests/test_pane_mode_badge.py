...
check("статус при проверке ядра назван словами владельца",
      "setStatus('ядро на связи - через LLM строится описание категории и создание черновиков')" in src and
      "setStatus('ядро на связи - шаги 1 и 3 идут мимо чата')" not in src,
