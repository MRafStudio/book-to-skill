      ...
      jsx(PaneBlock, {
        ...
        hint: mdSrc
          ...
          : (busy === 'rerun'
            ...
            : (analyzed ? 'Следующим шагом укажи категорию и имя скилла'
              : (staleReport ? 'входы изменились: отчёт ниже - от прежних входов, прогони разбор заново' : 'скачать и вычистить текст: мимо чата, прямо в ядро'))),
        foot: jsx(NextBtn, {
          label: 'ДАЛЕЕ →',
          onClick: next2,
